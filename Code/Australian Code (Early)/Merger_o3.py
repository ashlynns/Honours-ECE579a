...
for date in dates:
	...
	if date in a1.index:
		t1 = int(a1.loc[date,' o3'])
		c +=1
	if date in a2.index:
		t2 = int(a2.loc[date,' o3'])
		c+=1
	if date in a3.index:
		t3 = int(a3.loc[date,' o3'])
		c+=1
	if date in a4.index:
		t4 = int(a4.loc[date,' o3'])
		c+=1
	if c ==0:
		a_dict[date]= None 
	if c !=0:
...
for date in dates:
	...
	if date in b1.index:
		t1 = int(b1.loc[date,' o3'])
		c +=1
	if date in b2.index:
		t2 = int(b2.loc[date,' o3'])
		c+=1
	if date in b3.index:
		t3 = int(b3.loc[date,' o3'])
		c+=1
	if date in b4.index:
		t4 = int(b4.loc[date,' o3'])
		c+=1
	if date in b5.index:
		t5 = int(b5.loc[date,' o3'])
		c+=1
	if date in b6.index:
		t6 = int(b6.loc[date,' o3'])
		c+=1
	if date in b7.index:
		t7 = int(b7.loc[date,' o3'])
		c+=1
	if date in b8.index:
		t8 = int(b8.loc[date,' o3'])
		c+=1
	if date in b9.index:
		t9 = int(b9.loc[date,' o3'])
		c+=1
	if c ==0:
		b_dict[date]= None 
	if c !=0:
...
for date in dates:
	...
	if date in m1.index:
		t1 = int(m1.loc[date,' o3'])
		c +=1
	if date in m2.index:
		t2 = int(m2.loc[date,' o3'])
		c+=1
	if date in m3.index:
		t3 = int(m3.loc[date,' o3'])
		c+=1
	if date in m4.index:
		t4 = int(m4.loc[date,' o3'])
		c+=1
	if date in m5.index:
		t5 = int(m5.loc[date,' o3'])
		c+=1
	if date in m6.index:
		t6 = int(m6.loc[date,' o3'])
		c+=1
	if date in m7.index:
		t7 = int(m7.loc[date,' o3'])
		c+=1
	if date in m8.index:
		t8 = int(m8.loc[date,' o3'])
		c+=1
	if date in m9.index:
		t9 = int(m9.loc[date,' o3'])
		c+=1
	if date in m10.index:
		t10 = int(m10.loc[date,' o3'])
		c+=1
	if date in m11.index:
		t11 = int(m11.loc[date,' o3'])
		c+=1
	if c ==0:
		m_dict[date]= None 
	if c !=0:
...
for date in dates:
	c, t1, t2, t3, t4 = 0, 0, 0, 0, 0
	if date in p1.index:
		t1 = int(p1.loc[date,' o3'])
		c +=1
	if date in p2.index:
		t2 = int(p2.loc[date,' o3'])
		c+=1
	if date in p3.index:
		t3 = int(p3.loc[date,' o3'])
		c+=1
	if date in p4.index:
		t4 = int(p4.loc[date,' o3'])
		c+=1
	if c ==0:
		p_dict[date]= None 
	if c !=0:
...
for date in dates:
	...
	if date in s1.index:
		t1 = int(s1.loc[date,' o3'])
		c +=1
	if date in s2.index:
		t2 = int(s2.loc[date,' o3'])
		c+=1
	if date in s3.index:
		t3 = int(s3.loc[date,' o3'])
		c+=1
	if date in s4.index:
		t4 = int(s4.loc[date,' o3'])
		c+=1
	if date in s5.index:
		t5 = int(s5.loc[date,' o3'])
		c+=1
	if date in s6.index:
		t6 = int(s6.loc[date,' o3'])
		c+=1
	if date in s7.index:
		t7 = int(s7.loc[date,' o3'])
		c+=1
	if date in s8.index:
		t8 = int(s8.loc[date,' o3'])
		c+=1
	if date in s9.index:
		t9 = int(s9.loc[date,' o3'])
		c+=1
	if date in s10.index:
		t10 = int(s10.loc[date,' o3'])
		c+=1
	if date in s11.index:
		t11 = int(s11.loc[date,' o3'])
		c+=1
	if date in s12.index:
		t12 = int(s12.loc[date,' o3'])
		c+=1
	if date in s13.index:
		t13 = int(s13.loc[date,' o3'])
		c+=1
	if date in s14.index:
		t14 = int(s14.loc[date,' o3'])
		c+=1
	if date in s15.index:
		t15 = int(s15.loc[date,' o3'])
		c+=1
	if c ==0:
		s_dict[date]= None 
	if c !=0:
...
output_df.to_csv('Datasets/Average_o3.csv')
